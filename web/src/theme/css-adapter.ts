...
const cssVariableMap = {
  ...
  metaCount: '--theme-color-meta-count',
  metaCountSoft: '--theme-color-meta-count-soft',
  metaCountAlt: '--theme-color-meta-count-alt',
  metaCountAltSoft: '--theme-color-meta-count-alt-soft',
...
const legacyVariableMap: Record<string, keyof SemanticColorTokens> = {
  ...
  '--color-count-alt': 'metaCountAlt',
  '--color-count-alt-bg': 'metaCountAltSoft',
