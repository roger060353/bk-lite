...
from apps.alerts.common.instance_identity import merge_stable_identity_labels
from apps.alerts.constants.constants import AlertStatus, LevelType, SessionStatus
...
class AlertBuilder:
    ...
    def _resolve_standard_fields(events) -> Dict[str, Any]:
        ...
        return {
            ...
            "labels": merge_stable_identity_labels(event_list, AlertBuilder._get_consistent_labels(event_list)),
    ...
    def _update_existing_alert(
        ...
        standard_fields = AlertBuilder._resolve_standard_fields(alert.events.select_related("source").all().order_by("pk"))
