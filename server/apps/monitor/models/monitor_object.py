...
class MonitorObject(TimeInfo, MaintainerInfo):
    ...
    type = models.ForeignKey(
        MonitorObjectType, on_delete=models.SET_NULL, null=True, blank=True, db_column="type", related_name="monitor_objects", verbose_name="监控对象分类"
    )
...
class MonitorInstance(TimeInfo, MaintainerInfo):
    ...
    k8s_daemonset_tolerations = models.JSONField(
        null=True,
        blank=True,
        default=None,
